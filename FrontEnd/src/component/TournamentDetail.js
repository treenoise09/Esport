...
145 145 c80 80 147 145 150 145 3 0 143 -138 312 -307z"/>
                    ...
                    <Grid item xs={10}>
                      ...
                      <div style={{ color: '#FF8C00' }}>- แข่งขันแบบ {tournamentDetails.data.win_condition} 5 ผู้เล่น / ทีม + ตัวสำรองมากที่สุด 1 คน
                      </div>
                    </Grid>
                    ...
                    <Grid item xs={10}>
                      ...
                      <div style={{ color: '#FF8C00' }}>- ทำการแข่งขันแบบ {tournamentDetails.data.type}</div>
                    </Grid>
  ...
  <div style={{ color: '#FF8C00' }}>
    - รับสมัคร : {tournamentDetails.data.start_date} - {tournamentDetails.data.regis_end}
  </div>
                    ...
                    <Grid item xs={10}>
                      {/* Details for CalendarMonthIcon */}
                      <div style={{ color: '#FF8C00' }}>- เริ่มทำการแข่งขัน {tournamentDetails.data.end_date}</div>
                    </Grid>
