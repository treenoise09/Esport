    ...
    <ThemeProvider theme={defaultTheme}>
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <Container component="main" maxWidth="xl" style={{ flex: 1 }}>
          <CssBaseline />
          <div style={{color:'#fff'}}><h1 style={{marginBottom:'0'}}>AOV WorldTour 2023</h1></div>
          ...
          >
            <div style={{ flex: '1', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src={Tour} alt="description" style={{ flex: '1', height: '100%', maxWidth: '100%', borderRadius: '10px' }} />
            </div>
            <div style={{ 
              flex: '1', 
            display: 'flex', 
            ...
            borderRadius: '10px'
              ...
              <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }} style={{ width: '70%' }}>
                <div style={{ backgroundColor: '#000', borderRadius: '20px', height: '100%', width: '100%' }}>
...
145 145 c80 80 147 145 150 145 3 0 143 -138 312 -307z"/>
                    ...
                    <Grid item xs={10}>
                      ...
                      <div style={{ color: '#FF8C00' }}>- แข่งขันแบบ Single Elemination(แพ้ตกรอบ)
                        5 ผู้เล่น / ทีม + ตัวสำรองมากที่สุด 1 คน
                      </div>
                    </Grid>

                    <Grid item xs={2}>
                      <LanguageIcon fontSize="inherit" style={{ color: '#fff', fontSize: '24px' }} />
                    </Grid>
                    <Grid item xs={10}>
                      {/* Details for LanguageIcon */}
                      <div style={{ color: '#FF8C00' }}>- ทำการแข่งขันแบบ Online</div>
                    </Grid>
                    ...
                    <Grid item xs={10}>
                      ...
                      <div style={{ color: '#FF8C00' }}>- รับสมัคร 1 เมษายน - 10 พฤษภาคม 2566</div>
                    </Grid>
                    ...
                    <Grid item xs={10}>
                      {/* Details for CalendarMonthIcon */}
                      <div style={{ color: '#FF8C00' }}>- เริ่มทำการแข่งขัน 15 พฤษภาคม 2566</div>
                    </Grid>
